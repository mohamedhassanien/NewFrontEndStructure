...
import { ApplicationsService } from '../../../services/components/applications.service';
...
export class ApplicationComponent {
  ...
  applicationStatus: string[] = ['Sent to school', 'Interview preparation', 'Accepted', 'Alternance found', 'Deposit paid', 'Visa ok', 'Visa ok + Alternance', 'Visa rejected', 'Rejected', 'Canceled'];
  ...
  constructor(private ApplicationsService: ApplicationsService, private _Router: Router, private _ModalService: NgbModal) {

  }

  ngOnInit() {
    this.ApplicationsService.getProductsMini().then((data: any) => {
